...
//        translatePlayer();
    ...
    public void movePlayer(int diceValue){
        if (currentPiecePosition + diceValue <= 100){// coin does not move beyond 100
    ...
    private void translatePlayer(){
        ...
        TranslateTransition animate = new TranslateTransition(Duration.millis(1000), this.gamePiece);//moving coin time
        animate.setToX(this.xPosition);
        animate.setToY(this.yPosition);
        animate.setAutoReverse(false);//comeback
        animate.play();
